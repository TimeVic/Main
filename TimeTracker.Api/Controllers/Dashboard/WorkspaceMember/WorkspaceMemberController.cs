...
namespace TimeTracker.Api.Controllers.Dashboard.WorkspaceMember;

[ApiController]
[Authorize]
[Route("/dashboard/workspace/member")]
public class WorkspaceMemberController(ILifetimeScope scope) : MainApiControllerBase(scope)
{
    [HttpPost("add")]
