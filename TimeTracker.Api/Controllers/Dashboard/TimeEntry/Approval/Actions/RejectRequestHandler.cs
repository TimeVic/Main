...
public class RejectRequestHandler : IAsyncRequestHandler<RejectRequest, PaginatedListDto<TimeEntryDto>>
{
    ...
    public async Task<PaginatedListDto<TimeEntryDto>> ExecuteAsync(RejectRequest request)
    {
        ...
        var entries = await _approvalService.RejectBatchAsync(
            user,
            workspace,
