...
public class ApproveRequestHandler : IAsyncRequestHandler<ApproveRequest, PaginatedListDto<TimeEntryDto>>
{
    ...
    public async Task<PaginatedListDto<TimeEntryDto>> ExecuteAsync(ApproveRequest request)
    {
        ...
        var entries = await _approvalService.ApproveBatchAsync(
            user,
            workspace,
