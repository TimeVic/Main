...
public class UnapproveRequestHandler : IAsyncRequestHandler<UnapproveRequest, TimeEntryDto>
{
    ...
    public UnapproveRequestHandler(
        IMapper mapper,
    ...
    public async Task<TimeEntryDto> ExecuteAsync(UnapproveRequest request)
    {
        ...
        var updatedEntry = await _approvalService.UnapproveAsync(user, timeEntry);
