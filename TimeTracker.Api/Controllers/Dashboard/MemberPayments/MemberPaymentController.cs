...
namespace TimeTracker.Api.Controllers.Dashboard.MemberPayments;

[ApiController]
[Authorize]
[Route("/dashboard/member-payments")]
public class MemberPaymentController(ILifetimeScope scope) : MainApiControllerBase(scope)
{
    [HttpPost("add")]
