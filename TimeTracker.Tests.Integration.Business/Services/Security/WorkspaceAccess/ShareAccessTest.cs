...
public class ShareAccessTest: BaseTest
{
    ...
    public async Task ShouldProvideNewAccess_User()
    {
        ...
        var actualMembership = await _workspaceAccessService.ShareAccess(_workspace, expectedUser, expectedAccess,
    ...
    public async Task ShouldUpdateAccess_User()
    {
        ...
        await _workspaceAccessService.ShareAccess(_workspace, expectedUser, expectedAccess,
            new List<ProjectEntity>()
            {
                project2
            });
