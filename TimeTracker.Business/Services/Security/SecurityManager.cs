...
public class SecurityManager: ISecurityManager
{
    ...
    public async Task<bool> HasAccess<TEntity>(AccessLevel accessLevel, UserEntity user, TEntity? entity)
    {
        ...
        if (entity is ClientPaymentEntity clientPaymentEntity)
        {
            return await HasAccessToClientPayment(accessLevel, user, clientPaymentEntity);
        }
        ...
        if (entity is MessagingChannelEntity messagingChannelEntity)
        {
