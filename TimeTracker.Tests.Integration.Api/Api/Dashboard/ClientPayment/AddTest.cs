...
{
    private const string Url = "/dashboard/client-payments/add";
    ...
    [Fact]
    public async Task ShouldAddIfWorkspaceOwner()
    {
    ...
    [Fact]
    public async Task ShouldAddIfWorkspaceManager()
    {
    ...
    [Fact]
    public async Task ShouldNotAddIfWorkspaceUser()
    {
        var (otherToken, _, _) = await _userSeeder.CreateAuthorizedAndShareAsync(
            _workspace,
