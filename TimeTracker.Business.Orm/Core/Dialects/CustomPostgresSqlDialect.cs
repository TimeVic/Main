...
namespace TimeTracker.Business.Orm.Core.Dialects;
...
public class CustomPostgresSqlDialect : PostgreSQL82Dialect
{
    public CustomPostgresSqlDialect()
    {
        ...
        RegisterFunction("coalesce",
            new VarArgsSQLFunction(NHibernateUtil.String, "coalesce(", ", ", ")"));

        RegisterFunction("lower",
            new StandardSQLFunction("lower", NHibernateUtil.String));
    }
}
